...
Defines how SystemTimeManager recovers and sets the initial system time from last known good values on startup, creates the sentinel file, and broadcasts the initial time quality.
## Requirements
