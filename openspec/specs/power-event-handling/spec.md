...
Defines how SystemTimeManager subscribes to power mode change events and handles deep sleep entry and exit, including NTP service restart and time quality re-broadcast on wake.
## Requirements
