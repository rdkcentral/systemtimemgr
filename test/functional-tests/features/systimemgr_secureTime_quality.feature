...
Feature: Ensures SystemTimeManager Broadcasting Time Quality Messages
  ...
  Scenario: Verify SystemTimeManager should sent time quality Poor when Secure Time is not available.
    Given the SystemTimeManager is running
    When the SystemTimeManager binary is invoked
    Then the SystemTimeManager should sent time quality Poor Msg Initially when Secure Time is not available.

  Scenario: Verify SystemTimeManager should sent time quality Secure When Secure Time is available.
    Given the SystemTimeManager is running
    When the SystemTimeManager binary is invoked
    Then the SystemTimeManager should sent time quality Secure When Secure Time is available.
